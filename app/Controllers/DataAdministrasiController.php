...
class DataAdministrasiController extends BaseController
{
	...
	{
		$data_administrasi['data_administrasi'] = $this->data_administrasi->findAll();
		return view('data_administrasi/index', $data_administrasi);
	}
	...
	{
		return view('data_administrasi/create');
	}
	...
	public function xls()
	{
		$exportXls = $this->data_administrasi->findAll();
